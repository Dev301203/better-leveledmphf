...
\date{\today}
\input{generated_paper_numbers.tex}
...
\centering
\makebox[\linewidth][c]{%
    \includegraphics[width=1.08\linewidth]{figures/gamma_grid_serial.png}%
}
...
\subsection{Final Structure Size}
A separate exact-memory benchmark measured final structure size in bits per key for \texttt{better-mphf} and \texttt{bbhash-cpp} over the same $(n,\gamma)$ grid on multiplicative keys with one seed. \texttt{boomphf-rust} is omitted from this exact comparison because the crate does not expose a public in-memory size API. Table~\ref{tab:bits-per-key} reports the exact bits-per-key values for all tested gamma values at representative input sizes.
...
\toprule
$\gamma$ & impl & \PaperBitsTableNOne{} & \PaperBitsTableNTwo{} & \PaperBitsTableNThree{} & \PaperBitsTableNFour{} \\
\midrule
\PaperBitsGammaOneLabel{} & \texttt{better-mphf} & \PaperBitsGammaOneBetterNOne{} & \PaperBitsGammaOneBetterNTwo{} & \PaperBitsGammaOneBetterNThree{} & \PaperBitsGammaOneBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaOneCppNOne{} & \PaperBitsGammaOneCppNTwo{} & \PaperBitsGammaOneCppNThree{} & \PaperBitsGammaOneCppNFour{} \\
\PaperBitsGammaTwoLabel{} & \texttt{better-mphf} & \PaperBitsGammaTwoBetterNOne{} & \PaperBitsGammaTwoBetterNTwo{} & \PaperBitsGammaTwoBetterNThree{} & \PaperBitsGammaTwoBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaTwoCppNOne{} & \PaperBitsGammaTwoCppNTwo{} & \PaperBitsGammaTwoCppNThree{} & \PaperBitsGammaTwoCppNFour{} \\
\PaperBitsGammaThreeLabel{} & \texttt{better-mphf} & \PaperBitsGammaThreeBetterNOne{} & \PaperBitsGammaThreeBetterNTwo{} & \PaperBitsGammaThreeBetterNThree{} & \PaperBitsGammaThreeBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaThreeCppNOne{} & \PaperBitsGammaThreeCppNTwo{} & \PaperBitsGammaThreeCppNThree{} & \PaperBitsGammaThreeCppNFour{} \\
\PaperBitsGammaFourLabel{} & \texttt{better-mphf} & \PaperBitsGammaFourBetterNOne{} & \PaperBitsGammaFourBetterNTwo{} & \PaperBitsGammaFourBetterNThree{} & \PaperBitsGammaFourBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaFourCppNOne{} & \PaperBitsGammaFourCppNTwo{} & \PaperBitsGammaFourCppNThree{} & \PaperBitsGammaFourCppNFour{} \\
\PaperBitsGammaFiveLabel{} & \texttt{better-mphf} & \PaperBitsGammaFiveBetterNOne{} & \PaperBitsGammaFiveBetterNTwo{} & \PaperBitsGammaFiveBetterNThree{} & \PaperBitsGammaFiveBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaFiveCppNOne{} & \PaperBitsGammaFiveCppNTwo{} & \PaperBitsGammaFiveCppNThree{} & \PaperBitsGammaFiveCppNFour{} \\
\PaperBitsGammaSixLabel{} & \texttt{better-mphf} & \PaperBitsGammaSixBetterNOne{} & \PaperBitsGammaSixBetterNTwo{} & \PaperBitsGammaSixBetterNThree{} & \PaperBitsGammaSixBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaSixCppNOne{} & \PaperBitsGammaSixCppNTwo{} & \PaperBitsGammaSixCppNThree{} & \PaperBitsGammaSixCppNFour{} \\
\PaperBitsGammaSevenLabel{} & \texttt{better-mphf} & \PaperBitsGammaSevenBetterNOne{} & \PaperBitsGammaSevenBetterNTwo{} & \PaperBitsGammaSevenBetterNThree{} & \PaperBitsGammaSevenBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaSevenCppNOne{} & \PaperBitsGammaSevenCppNTwo{} & \PaperBitsGammaSevenCppNThree{} & \PaperBitsGammaSevenCppNFour{} \\
\PaperBitsGammaEightLabel{} & \texttt{better-mphf} & \PaperBitsGammaEightBetterNOne{} & \PaperBitsGammaEightBetterNTwo{} & \PaperBitsGammaEightBetterNThree{} & \PaperBitsGammaEightBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaEightCppNOne{} & \PaperBitsGammaEightCppNTwo{} & \PaperBitsGammaEightCppNThree{} & \PaperBitsGammaEightCppNFour{} \\
\PaperBitsGammaNineLabel{} & \texttt{better-mphf} & \PaperBitsGammaNineBetterNOne{} & \PaperBitsGammaNineBetterNTwo{} & \PaperBitsGammaNineBetterNThree{} & \PaperBitsGammaNineBetterNFour{} \\
 & \texttt{bbhash-cpp} & \PaperBitsGammaNineCppNOne{} & \PaperBitsGammaNineCppNTwo{} & \PaperBitsGammaNineCppNThree{} & \PaperBitsGammaNineCppNFour{} \\
\bottomrule
\end{tabular}
\caption{Final structure size in bits per key. Columns are representative input sizes and rows list all tested gamma values for both implementations.}
\label{tab:bits-per-key}
\end{table}
